...
func newCatalogCmd() *cobra.Command {
	...
	cmd.AddCommand(newCatalogAddCmd(), newCatalogListCmd(), newCatalogRemoveCmd(), newCatalogUpdateCmd(), newCatalogReorderCmd(), newCatalogLintCmd(), newCatalogPublishCmd(), newCatalogDisableCmd(), newCatalogEnableCmd(), newCatalogBuildCmd(), newCatalogFmtCmd(), newCatalogOutdatedCmd(), newCatalogBumpCmd(), newCatalogMissingCmd())
	return cmd
}
